<template>
  <div class="g-review-data" v-loading.fullscreen="loading">
    ...
    <show-evidence-for-dissent :arbi-info="arbiInfo" :hasReply='true'></show-evidence-for-dissent>
...
import showEvidenceForDissent from '@admin/components/showEvidenceForDissent'
export default {
  components: { reviewDialog, showEvidenceForDissent},
  data() {
    return {
      loading: false, //
      arbiInfo: {},
